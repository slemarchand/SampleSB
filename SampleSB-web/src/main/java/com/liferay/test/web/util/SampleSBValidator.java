...
public class SampleSBValidator {
    ...
    public static List<String> validateSampleSB(ActionRequest request)
        throws IOException {
...
//
//        if (!validateSamplesbBooleanStat(
//            ParamUtil.getString(request, "samplesbBooleanStat"))) {
//
...
//
//        if (!validateSamplesbDateTime(
//            ParamUtil.getString(request, "samplesbDateTime"))) {
//
...
//
//        if (!validateSamplesbDocument(
//            request.getAttribute("samplesbDocument").toString())) {
//
...
//
//        if (!validateSamplesbDocumentLibrary(
...
//
//        if (!validateSamplesbDouble(
//            ParamUtil.getString(request, "samplesbDouble"))) {
//
...
//
//        if (!validateSamplesbInteger(
//            ParamUtil.getString(request, "samplesbInteger"))) {
//
...
//        // Field samplesbText
//
//        if (!validateSamplesbText(
//            ParamUtil.getString(request, "samplesbText"))) {
//
...
//        }
    ...
    // TODO:this validation is needed for paging
    // public static boolean validateEditSampleSB(String rowsPerPage, String
    // dateFormat, String datetimeFormat,
    // List errors) {
    // boolean valid = true;
