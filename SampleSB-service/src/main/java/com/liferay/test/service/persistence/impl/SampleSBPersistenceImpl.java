...
public class SampleSBPersistenceImpl extends BasePersistenceImpl<SampleSB>
	 ...
	 */
	@Override
	public List<SampleSB> filterFindByG_S(long groupId, int status, int start,
		int end) {
	...
	public List<SampleSB> filterFindByG_S(long groupId, int status, int start,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_SAMPLESB_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_SAMPLESB_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_SAMPLESB_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(SampleSBModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, SampleSBImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, SampleSBImpl.class);
			}
			...
			return (List<SampleSB>)QueryUtil.list(q, getDialect(), start, end);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public SampleSB[] filterFindByG_S_PrevAndNext(long samplesbId,
		...
		throws NoSuchSampleSBException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_S_PrevAndNext(samplesbId, groupId, status,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_S_PrevAndNext(session, sampleSB, groupId,
					status, orderByComparator, true);

			array[1] = sampleSB;

			array[2] = filterGetByG_S_PrevAndNext(session, sampleSB, groupId,
					status, orderByComparator, false);
	...
	protected SampleSB filterGetByG_S_PrevAndNext(Session session,
		SampleSB sampleSB, long groupId, int status,
		OrderByComparator<SampleSB> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public int filterCountByG_S(long groupId, int status) {
		...
		query.append(_FILTER_SQL_COUNT_SAMPLESB_WHERE);
	 ...
	 */
	@Override
	public List<SampleSB> filterFindByG_U_S(long groupId, long userId,
		int status) {
	...
	public SampleSB[] filterFindByG_U_S_PrevAndNext(long samplesbId,
		...
		throws NoSuchSampleSBException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_U_S_PrevAndNext(samplesbId, groupId, userId, status,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_U_S_PrevAndNext(session, sampleSB, groupId,
					userId, status, orderByComparator, true);

			array[1] = sampleSB;

			array[2] = filterGetByG_U_S_PrevAndNext(session, sampleSB, groupId,
					userId, status, orderByComparator, false);
	...
	protected SampleSB filterGetByG_U_S_PrevAndNext(Session session,
		SampleSB sampleSB, long groupId, long userId, int status,
		OrderByComparator<SampleSB> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<SampleSB> filterFindByG_UT_ST(long groupId, String urlTitle,
		int status) {
	...
	public SampleSB[] filterFindByG_UT_ST_PrevAndNext(long samplesbId,
		...
		throws NoSuchSampleSBException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_UT_ST_PrevAndNext(samplesbId, groupId, urlTitle,
		...
		try {
			...
			array[0] = filterGetByG_UT_ST_PrevAndNext(session, sampleSB,
					groupId, urlTitle, status, orderByComparator, true);

			array[1] = sampleSB;

			array[2] = filterGetByG_UT_ST_PrevAndNext(session, sampleSB,
	...
	protected SampleSB filterGetByG_UT_ST_PrevAndNext(Session session,
		SampleSB sampleSB, long groupId, String urlTitle, int status,
		OrderByComparator<SampleSB> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<SampleSB> filterFindByGroupId(long groupId, int start, int end) {
	...
	public SampleSB[] filterFindByGroupId_PrevAndNext(long samplesbId,
		...
		throws NoSuchSampleSBException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(samplesbId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, sampleSB,
					groupId, orderByComparator, true);

			array[1] = sampleSB;

			array[2] = filterGetByGroupId_PrevAndNext(session, sampleSB,
	...
	protected SampleSB filterGetByGroupId_PrevAndNext(Session session,
		SampleSB sampleSB, long groupId,
		OrderByComparator<SampleSB> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public SampleSB[] filterFindByUserIdGroupId_PrevAndNext(long samplesbId,
		...
		throws NoSuchSampleSBException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByUserIdGroupId_PrevAndNext(samplesbId, userId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByUserIdGroupId_PrevAndNext(session, sampleSB,
					userId, groupId, orderByComparator, true);

			array[1] = sampleSB;

			array[2] = filterGetByUserIdGroupId_PrevAndNext(session, sampleSB,
					userId, groupId, orderByComparator, false);
	...
	protected SampleSB filterGetByUserIdGroupId_PrevAndNext(Session session,
		SampleSB sampleSB, long userId, long groupId,
		OrderByComparator<SampleSB> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "sampleSB.samplesbId";
	private static final String _FILTER_SQL_SELECT_SAMPLESB_WHERE = "SELECT DISTINCT {sampleSB.*} FROM SampleSB_SampleSB sampleSB WHERE ";
	private static final String _FILTER_SQL_SELECT_SAMPLESB_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {SampleSB_SampleSB.*} FROM (SELECT DISTINCT sampleSB.samplesbId FROM SampleSB_SampleSB sampleSB WHERE ";
	private static final String _FILTER_SQL_SELECT_SAMPLESB_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN SampleSB_SampleSB ON TEMP_TABLE.samplesbId = SampleSB_SampleSB.samplesbId";
	private static final String _FILTER_SQL_COUNT_SAMPLESB_WHERE = "SELECT COUNT(DISTINCT sampleSB.samplesbId) AS COUNT_VALUE FROM SampleSB_SampleSB sampleSB WHERE ";
